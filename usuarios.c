...
void Anadir_Usuario(usuarios *List_Usuario){
    ...
    id+=1;
    if(id>=100) itoa(id,List_Usuario[cont].id_usuario,10);
    else if(id>=10){
        strcat(itoa(id,List_Usuario[cont].id_usuario,10),"0");
        ...
        strcat(itoa(id,List_Usuario[cont].id_usuario,10),"00");
    ...
    strcpy(List_Usuario[cont].usuario,leer_campo(5,"Usser"));
...
void Modificar_Usuario(usuarios *List_Usuario){
    ...
    strcpy(List_Usuario[pos_mod].usuario,leer_campo(5,"Usser"));
