...
void modificar_calificacion(calificaciones *list_calificaciones, int id_calificacion, int longitud_array);

void borrar_calificacion(calificaciones *list_calificaciones, int id_calificacion, int longitud_array);
    ...
    do {
        ...
        switch (atoi(buff)) {
            case 1: {
                    ...
                    puts("");
                    modificar_calificacion(list_calificaciones, atoi(buff_num_calif)-1, longitud_array);
                }
              break;
            case 2:
                    puts("Se muestran a continuación todas las calificaciones del alumno.");
                    ...
                    puts("");
                    borrar_calificacion(list_calificaciones, atoi(buff_num_calif)-1, longitud_array);
              break;
            case 3:
                printf ("Input too long [%s]\n", buff);
              break;
...
void borrar_calificacion(calificaciones *list_calificaciones, int id_calificacion, int longitud_array) {
    ...
    printf("%li", (sizeof(list_calificaciones) / sizeof(calificaciones)));
    ...
    if(strcmp("y", election) == 0 || strcmp("yes", election)) {
        for(i = id_calificacion; i < (sizeof(*list_calificaciones) / sizeof(calificaciones)); i++) {
            list_calificaciones[id_calificacion] = list_calificaciones[id_calificacion+1];
        }
        /*printf("=>>>>>>>>>>>>>>>>%li<<<<<<<<<<<<<<<=", (sizeof(*list_calificaciones) / sizeof(calificaciones))-1);*/
    }
    
    /*list_calificaciones = (calificaciones *) realloc(list_calificaciones, (sizeof(*list_calificaciones) / sizeof(calificaciones))-1);*/
    return;
}
...
void modificar_calificacion(calificaciones *list_calificaciones, int id_calificacion, int longitud_array) {
    ...
    if(atoi(new_value_calif) < 0 || atoi(new_value_calif) > 10) {
        ...
        puts("");
        modificar_calificacion(list_calificaciones, id_calificacion, longitud_array);
        return;
    }
...
int main(void) {
    ...
    menu_calificaciones(new_list_calificaciones, 342312, (sizeof(list_calificaciones) / sizeof(calificaciones)));
